...
typedef struct client_bundle{
    ...
    unsigned int is_celebrity; // set to 1 when nb_followers surpass BABBLE_CELEBRITY_THRESHOLD
    struct celeb_publication *publication_head; // Linked list of publications with each post being added at the head
} client_bundle_t;
